...
document.getElementById('loginButton').addEventListener('click', async () => {
  // Replace 'YOUR_COOKIE_NAME' with the captured and manipulated cookie name
  // Replace 'YOUR_COOKIE_VALUE' with the captured and manipulated cookie value
  setCookie('YOUR_COOKIE_NAME', 'YOUR_COOKIE_VALUE');
  // Rest of the code...
});
